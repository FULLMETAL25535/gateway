        ...
        option = {
            ...
            xAxis: [{
                ...
                data: ['0点', '1点', '2点', '3点', '4点', '5点', '6点', '7点', '8点', '9点', '10点', '11点',
                    '12点', '13点', '14点', '15点', '16点', '17点', '18点', '19点', '20点','21点','23点'
                ],
                axisLabel: {
                    show: true,
                    textStyle: {
            ...
            series: [

                {
                    ...
                    data: [81.4, 82.7, 82.7, 82.6, 82.2, 81.7, 81.8, 81.0, 81.3, 79.3, 78.3, 76.3, 75.3, 74.3, 73.3, 72.3, 72.3, 71.3, 70.3, 78.3, 79.3, 82.3, 92.6],
                },
                {
                    name: '温度',
                    type: 'bar',
                    ...
                    data: [30.0, 30.7, 29.7, 28.6, 28.2, 27.7, 28.8, 28.0, 29.3, 30.3, 30.3, 31.3, 32.3, 32.3, 33.3, 33.3, 33.3, 33.3, 32.3, 32.3, 31.3, 29.3, 28.6],
                },
                {
                    name: '累计',
                    type: 'line',
